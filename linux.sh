...
case $choice in
   ...
   echo "nameserver 223.6.6.6" >> /etc/resolv.conf
    ...
    12)
        echo "正在换源"
        curl -sSL https://github.com/Utuobw/Linux-toolbox/blob/main/ChangeMirrors.sh -o main.sh && chmod +x main.sh && ./main.sh
        ;;
    13)
        echo "正在安装xui面板"
    ...
    18)
        echo "正在安装旧版工具箱"
        sudo curl -O https://github.com/Utuobw/Linux-toolbox/blob/main/install.sh && sudo bash install.sh
        ;;
    19)
        echo "正在安装1panel面板"
